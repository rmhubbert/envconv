...
func TestToBoolWithDefault(t *testing.T) {
	testData := []ToBoolWithDefaultTest{
		{"TEST_BOOL_WITH_DEFAULT_1", "1", true, true},
		{"TEST_BOOL_WITH_DEFAULT_true", "true", true, true},
		{"TEST_BOOL_WITH_DEFAULT_TRUE", "TRUE", true, true},
		{"TEST_BOOL_WITH_DEFAULT_tRuE", "tRuE", true, true},
		{"TEST_BOOL_WITH_DEFAULT_0", "0", false, false},
		{"TEST_BOOL_WITH_DEFAULT_false", "false", false, false},
		{"TEST_BOOL_WITH_DEFAULT_FALSE", "FALSE", false, false},
		{"TEST_BOOL_WITH_DEFAULT_FaLsE", "FaLsE", false, false},
		{"TEST_BOOL_WITH_DEFAULT_NOTABOOL", "notabool", false, false},
	}
